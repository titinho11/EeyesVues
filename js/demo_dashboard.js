$(function(){        
    ...
    /*Morris.Donut({
        ...
        data: [
            {label: "Candidat1", value: 2513},
            {label: "Canditat2", value: 1764},
            {label: "Candidat3", value: 311}
        ],
    ...
    /*Morris.Bar({
        ...
        data: [
            { y: 'Candidat1', a: 75, b: 35, c:70},
            { y: 'Candidat2', a: 64, b: 26, c:50 },
            { y: 'Candidat3', a: 78, b: 39, c:45 },
            { y: 'Candidat4', a: 82, b: 34, c:57 },
            { y: 'Candidat5', a: 86, b: 39, c:33 },
            { y: 'Candidat6', a: 94, b: 40, c:22 },
            { y: 'Candidat7', a: 96, b: 41, c:70 }
        ],
        xkey: 'y',
        ykeys: ['a', 'b','c'],
        labels: ['Elecam', 'Majorité', 'Vrai'],
